...
namespace OfficeStaff.Controllers
{
    ...
    public class LocationController : Controller
    {
        ...
        public IActionResult ReadLocation(int locationId)
        {
            ...
            var location = _mapper.Map<LocationDto>(_locationRepository.ReadLocation(locationId));
        ...
        public IActionResult CreateLocation([FromQuery] int countryId,[FromBody] LocationDto locationCreate)
        {
            ...
            var location = _locationRepository.ReadLocations().Where(c => c.Name.Trim().ToUpper() == locationCreate.Name.TrimEnd().ToUpper()).FirstOrDefault();
            ...
            locationMap.Country = _countryRepository.ReadCountry(countryId);    
